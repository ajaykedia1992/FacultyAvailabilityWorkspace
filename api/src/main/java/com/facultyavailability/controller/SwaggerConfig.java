...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfo("Faculty Api", "Functionalities provided by the faculty api's", "about:blank",
                "TechBOULDER.facultyAvaliability.dev <faculty.dev@gmail.com>", "My Apps API Licence Type", "about:blank");
        return apiInfo;
    }
